...
<%
 /**
  * @Class Name  : SysCalendar.jsp
  * @Description : SysCalendar 화면
	...
	if (varParam.sDate) {
		...
		if(sDate.length == 10) {
			if(pForm.init.value != "OK") {
				pForm.init.value  = "OK";
				varForm.action      = "<c:url value='/mng/cmm/cal/callCal.do'/>";
...
<body>
<form name="Form" action ="<c:url value='/mng/cmm/cal/callCal.do'/>" method="post">
