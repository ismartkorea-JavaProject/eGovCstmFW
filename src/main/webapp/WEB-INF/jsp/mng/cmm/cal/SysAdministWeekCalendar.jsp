...
<%
 /**
  * @Class Name  : SysAdministWeekCalendar.jsp
  * @Description : SysAdministWeekCalendar 화면
...
<DIV id="content">
<!-- ------------------------------------------------------------------ 상단타이틀 -->
<form name="administWeekCalendar" action ="<c:url value='/mng/cmm/cal/SysAdministWeekCalendar.do'/>" method="post">
