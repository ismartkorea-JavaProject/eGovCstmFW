...
<%
 /**
  * @Class Name  : SysAdministDayCalendar.jsp
  * @Description : SysAdministDayCalendar 화면
...
<DIV id="content">
<!-- ------------------------------------------------------------------ 상단타이틀 -->
<form name="administDayCalendar" action ="<c:url value='/mng/cmm/cal/SysAdministDayCalendar.do'/>" method="post">
