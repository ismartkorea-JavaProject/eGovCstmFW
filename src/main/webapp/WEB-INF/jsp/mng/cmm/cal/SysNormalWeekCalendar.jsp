...
<%
 /**
  * @Class Name  : SysNormalWeekCalendar.jsp
  * @Description : SysNormalWeekCalendar 화면
...
<DIV id="content">
<!-- ------------------------------------------------------------------ 상단타이틀 -->
<form name="normalWeekCalendar" action ="<c:url value='/mng/cmm/cal/SysNormalWeekCalendar.do'/>" method="post">
