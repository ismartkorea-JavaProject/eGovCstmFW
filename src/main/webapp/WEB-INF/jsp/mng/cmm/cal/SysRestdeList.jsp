...
<%
 /**
  * @Class Name  : SysRestdeList.jsp
  * @Description : SysRestdeList 화면
...
function fn_egov_pageview(pageNo){
	...
	document.listForm.action = "<c:url value='/mng/cmm/cal/SysRestdeList.do'/>";
...
function fn_egov_regist_Restde(){
	location.href = "<c:url value='/mng/cmm/cal/SysRestdeRegist.do' />";
}
/* ********************************************************
 * 상세회면 처리 함수
 ******************************************************** */
function fn_egov_detail_Restde(restdeNo){
	...
	varForm.action           = "<c:url value='/mng/cmm/cal/SysRestdeDetail.do'/>";
...
<form name="listForm" action="<c:url value='/mng/cmm/cal/SysRestdeList.do'/>" method="post">
