...
<%
 /**
  * @Class Name  : SysNormalMonthCalendar.jsp
  * @Description : SysNormalMonthCalendar 화면
...
function fnChangeCalendar(year, month){
	...
	varForm.action      = "<c:url value='/mng/cmm/cal/SysNormalMonthCalendar.do'/>";
...
<DIV id="content">
<!-- ------------------------------------------------------------------ 상단타이틀 -->
<form name="normalMonthCalendar" action ="<c:url value='/mng/cmm/cal/SysNormalMonthCalendar.do'/>" method="post">
