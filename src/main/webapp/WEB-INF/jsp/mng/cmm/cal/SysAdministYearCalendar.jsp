...
<%
 /**
  * @Class Name  : SysAdministYearCalendar.jsp
  * @Description : SysAdministYearCalendar 화면
...
<DIV id="content">
<!-- ------------------------------------------------------------------ 상단타이틀 -->
<form name="administYearCalendar" action ="<c:url value='/mng/cmm/cal/SysAdministYearCalendar.do'/>" method="post">
