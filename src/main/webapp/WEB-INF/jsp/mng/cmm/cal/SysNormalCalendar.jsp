...
<%
 /**
  * @Class Name  : SysNormalCalendar.jsp
  * @Description : SysNormalCalendar 화면
	...
	if (varParam.sDate) {
		...
		if(sDate.length == 10) {
			if(pForm.init.value != "OK") {
				pForm.init.value  = "OK";
				varForm.action      = "<c:url value='/mng/cmm/cal/SysselectNormalCalendar.do'/>";
...
<form name="Form" action ="<c:url value='/mng/cmm/cal/SysselectNormalCalendar.do'/>" method="post">
