...
<%
 /**
  * @Class Name  : SysNormalYearCalendar.jsp
  * @Description : SysNormalYearCalendar 화면
...
<DIV id="content">
<!-- ------------------------------------------------------------------ 상단타이틀 -->
<form name="normalYearCalendar" action ="<c:url value='/mng/cmm/cal/SysNormalYearCalendar.do'/>" method="post">
