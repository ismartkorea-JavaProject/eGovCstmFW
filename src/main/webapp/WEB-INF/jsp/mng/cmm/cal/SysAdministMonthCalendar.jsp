...
<%
 /**
  * @Class Name  : SysAdministMonthCalendar.jsp
  * @Description : SysAdministMonthCalendar 화면
...
function fnChangeCalendar(year, month){
	...
	varForm.action      = "<c:url value='/mng/cmm/cal/SysAdministMonthCalendar.do'/>";
...
<DIV id="content">
<!-- ------------------------------------------------------------------ 상단타이틀 -->
<form name="administMonthCalendar" action ="<c:url value='/mng/cmm/cal/SysAdministMonthCalendar.do'/>" method="post">
