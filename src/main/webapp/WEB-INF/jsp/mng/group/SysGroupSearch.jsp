<%-- 
  Class Name : SysGroupSearch.jsp 
  Description : 그룹 검색 화면
...
function fncSelectGroupList(pageNo){
 ...
 // document.listForm.action = "<c:url value='/mng/grp/SysGroupSearchList.do'/>";
...
//-->
	...
	<form name="listForm" action="<c:url value='/mng/grp/SysGroupSearchList.do'/>" method="post">
