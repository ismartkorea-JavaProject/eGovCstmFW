<%-- 
  Class Name : SysTemplateUpdt.jsp
...
<script type="text/javascript">
    function fn_egov_update_tmplatInfo() {
        ...
        if (confirm('<spring:message code="common.update.msg" />')) {
            document.templateInf.action = "<c:url value='/mng/bbs/com/updateTemplateInf.do'/>";
...
<title>내부업무 사이트 > 내부서비스관리 > 게시판템플릿관리</title>
    ...
    <body class="sb-nav-fixed" onload="fn_egov_selectTmplatType(document.templateInf.tmplatSeCode)">
							...
							<!--<div style="height: 100vh">-->
                                ...
                                <div class="board_view_bot">
                                    ...
                                    <div class="right_col btn1">
                                        ...
                                        <a href="<c:url value='/mng/bbs/com/selectTemplateInfs.do'/>" class="btn btn_blue_46 w_100" onclick="javascript:fn_egov_select_tmplatInfo(); return false;"><spring:message code="button.list" /></a><!-- 목록 -->
                                    </div>
                                </div>
                                <!-- 버튼 끝 -->
