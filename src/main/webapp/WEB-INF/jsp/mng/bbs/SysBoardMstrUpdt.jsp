<%-- 
  Class Name : SysBoardMstrUpdt.jsp 
...
<script type="text/javascript">
    ...
    function fn_egov_update_brdMstr(){
        ...
        if(confirm('<spring:message code="common.update.msg" />')){
            document.boardMaster.action = "<c:url value='/mng/bbs/UpdateBBSMasterInf.do'/>";
            document.boardMaster.submit();                  
        }
    }   
    
    function fn_egov_select_brdMstrList(){
        document.boardMaster.action = "<c:url value='/mng/bbs/SelectBBSMasterInfs.do'/>";
        document.boardMaster.submit();  
    }   
    
    function fn_egov_delete_brdMstr(){
        if(confirm('<spring:message code="common.delete.msg" />')){
            document.boardMaster.action = "<c:url value='/mng/bbs/DeleteBBSMasterInf.do'/>";
            document.boardMaster.submit();  
        }       
    }
    ...
    function fn_egov_inqire_tmplatInqire(){
    	...
    	.html('<iframe style="border: 0px; " src="' + "<c:url value='/mng/com/selectTemplateInfsPop.do'/>" +'" width="100%" height="100%"></iframe>')
    	.dialog({
        	autoOpen: false,
            modal: true,
            width: 1050,
                    ...
                    <div class="container-fluid px-4">
                        ...
                        <div class="card mb-4">
							<!--<div style="height: 100vh">-->
								...
								<form:form modelAttribute="boardMaster" name="boardMaster" action="<c:url value='/mng/bbs/SelectBBSMasterInfs.do'/>" method="post" >
...
<%--                                                     <button type="button" class="btn" onclick="fn_egov_inqire_tmplatInqire(); return false;"><spring:message code='button.inquire' /></button><!-- 조회 --> --%>
                                ...
                                <div class="board_view_bot">
                                    ...
                                    <div class="right_col btn1">
                                        ...
                                        <a href="<c:url value='/mng/bbs/SelectBBSMasterInfs.do'/>" class="btn btn_blue_46 w_100" onclick="javascript:fn_egov_select_brdMstrList(); return false;"><spring:message code="button.list" /></a><!-- 목록 -->
                                    </div>
                                </div>
                                <!-- // 목록/저장버튼 끝  -->
