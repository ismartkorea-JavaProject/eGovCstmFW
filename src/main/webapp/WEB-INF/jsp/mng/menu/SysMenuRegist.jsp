<%-- 
  Class Name : SysMenuRegist.jsp 
  Description : 그룹 입력 화면
...
function insertMenuManage(form) {
    if(!validateMenuManageVO(form)){            
    	...
    	if(confirm("<spring:message code="common.save.msg" />")){
         form.action="<c:url value='/mng/menu/SysMenuRegistInsert.do'/>";
         form.submit();
    	}
    }
}
...
function searchFileNm() {
	...
	.html('<iframe style="border: 0px; " src="' + "<c:url value='/mng/prm/SysProgramListSearch.do'/>" +'" width="100%" height="100%"></iframe>')
	.dialog({
    	autoOpen: false,
        modal: true,
        width: 1100,
                    ...
                    <div class="container-fluid px-4">
                        ...
                        <div class="card mb-4">
							<!--<div style="height: 100vh">-->
								...
								<form:form modelAttribute="menuManageVO" name="menuManageVO" method="post" action="${pageContext.request.contextPath}/mng/menu/SysMenuRegistInsert.do">
                                ...
                                <div class="board_view_bot">
                                    ...
                                    <div class="right_col btn1">
                                        ...
                                        <a href="<c:url value='/mng/menu/EgovMenuManageSelect.do'/>" class="btn btn_blue_46 w_100" onclick="javascript:selectList(); return false;"><spring:message code="button.list" /></a><!-- 목록 -->
                                    </div>
                                </div>
                                <!-- // 목록/저장버튼 끝  -->
