<%-- 
  Class Name : SysLoginPolicyRegist.jsp 
  Description : 정책 입력 화면
...
function fncLoginPolicyInsert() {
    ...
    var varFrom = document.getElementById("loginPolicy");
    varFrom.action = "<c:url value='/mng/policy/addLoginPolicy.do'/>";
            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid px-4">
								...
								<form:form modelAttribute="loginPolicy" method="post" action="${pageContext.request.contextPath}/mng/policy/addLoginPolicy.do">
