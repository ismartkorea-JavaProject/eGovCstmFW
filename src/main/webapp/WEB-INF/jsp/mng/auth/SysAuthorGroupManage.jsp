<%-- 
  Class Name : SysAuthGroupManage.jsp 
  Description : 권한 그룹 관리 화면
...
function fncSelectAuthorGroupList(pageNo){
    ...
    document.listForm.action = "<c:url value='/mng/auth/grp/SysAuthorGroupList.do'/>";
...
function fncAddAuthorGroupInsert() {
    ...
    if(confirm('<spring:message code="common.regist.msg" />')) {
        document.listForm.action = "<c:url value='/mng/auth/grp/SysAuthorGroupInsert.do'/>";
        document.listForm.submit();
    }
}
...
function fncAuthorGroupDeleteList() {
    ...
    if(confirm('<spring:message code="common.delete.msg" />')) {
        document.listForm.action = "<c:url value='/mng/auth/grp/SysAuthorGroupDelete.do'/>";
        document.listForm.submit(); 
    }
}
...
function fncSelectAuthorGroupPop() {
    ...
    if(document.listForm.searchCondition.value == '3') {
    	...
    	.html('<iframe style="border: 0px; " src="' + "<c:url value='/mng/grp/SysGroupSearchView.do'/>" + '" width="100%" height="100%"></iframe>')
    	.dialog({
        	autoOpen: false,
            modal: true,
            width: 1100,
        ...
        <div id="layoutSidenav">
            ...
            <div id="layoutSidenav_content">
                <main>
								...
								<form:form id="listForm" name="listForm" action="<c:url value='/mng/auth/grp/SysAuthorGroupList.do'/>" method="post">
