<%-- 
  Class Name : SysAuthorRoleManage.jsp 
  Description : 권한 롤 관리 화면
...
function fncSelectAuthorRole(roleCode) {
    ...
    document.listForm.action = "<c:url value='/mng/auth/SysRole.do'/>";
    document.listForm.submit();     
}
...
function fncAddAuthorRoleInsert() {
    if(fncManageChecked()) {
        if(confirm('<spring:message code="common.regist.msg" />')) {
            document.listForm.action = "<c:url value='/mng/auth/SysAuthorRoleInsert.do'/>";
            document.listForm.submit();
        }
    } else return;
}
            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid px-4">
								...
								<form:form name="listForm" action="<c:url value='/mng/auth/SysAuthorRoleList.do'/>" method="post">
