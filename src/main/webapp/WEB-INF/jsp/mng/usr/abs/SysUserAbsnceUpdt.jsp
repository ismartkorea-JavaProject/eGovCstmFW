<%-- 
  Class Name : SysUserAbsnceUpdt.jsp 
  Description : 수정 화면
...
function fncUserAbsnceUpdate() {
    ...
    var varFrom = document.getElementById("userAbsnce");
    varFrom.action = "<c:url value='/mng/usr/abs/updtUserAbsnce.do'/>";
                    ...
                    <div class="container-fluid px-4">
                                ...
                                <div class="board_view_bot">
                                    <div class="left_col btn3">
                                    	<a href="<c:url value='/mng/usr/abs/removeUserAbsnce.do'/>?userId=<c:out value='${userAbsnceVO.userId}'/>&amp;selAbsnceAt=<c:out value='${userAbsnceVO.selAbsnceAt}'/>" class="btn btn_skyblue_h46 w_100" onclick="fncUserAbsnceDelete(); return false;">
                                    		<spring:message code="button.delete" />
                                    	</a><!-- 삭제 -->
                                    </div>

                                    <div class="right_col btn1">
                                        <a href="#LINK" class="btn btn_blue_46 w_100" onclick="JavaScript:fncUserAbsnceUpdate(); return false;"><spring:message code="button.save" /></a><!-- 저장 -->
