<%-- 
  Class Name : SysUserSelectUpdt.jsp 
...
<validator:javascript formName="userManageVO" staticJavascript="false" xhtml="true" cdata="false"/>
 ...
 function fnDeleteUser(checkedIds) {
     if(confirm("<spring:message code="common.delete.msg" />")){
         ...
         document.userManageVO.action = "<c:url value='/mng/usr/SysUserDelete.do'/>";
         document.userManageVO.submit(); 
     }
 }
 function fnPasswordMove(){
     document.userManageVO.action = "<c:url value='/mng/usr/SysUserPasswordUpdtView.do'/>";
     document.userManageVO.submit();
 }
 function fnUpdate(){
                    ...
                    <div class="container-fluid px-4">
                        ...
                        <div class="card mb-4">
							<!--<div style="height: 100vh">-->
								...
								<form:form modelAttribute="userManageVO" action="${pageContext.request.contextPath}/mng/usr/SysUserSelectUpdt.do" name="userManageVO" method="post" >
                                ...
                                <div class="board_view_bot">
                                    <div class="left_col btn3">
                                        <a href="<c:url value='/mng/usr/SysUserDelete.do'/>" class="btn btn_skyblue_h46 w_100" onclick="fnDeleteUser('<c:out value='${userManageVO.userTy}'/>:<c:out value='${userManageVO.uniqId}'/>'); return false;"><spring:message code="button.delete" /></a><!-- 삭제 -->
                                        <%--<a href="<c:url value='/mng/usr/SysUserPasswordUpdtView.do'/>" class="btn btn_skyblue_h46 w_100" onclick="fnPasswordMove(); return false;"><spring:message code="button.passwordUpdate" /></a><!-- 비밀번호변경 --> --%>
