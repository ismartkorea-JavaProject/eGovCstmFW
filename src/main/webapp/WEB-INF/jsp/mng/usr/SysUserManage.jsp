...
function fnDeleteUser() {
    ...
    if(checkedIds.length > 0) {
        ...
        if(confirm("<spring:message code="common.delete.msg" />")){
            ...
            document.listForm.action = "<c:url value='/mng/usr/SysUserDelete.do'/>";
...
function fnSelectUser(id) {
    ...
    document.listForm.action = "<c:url value='/mng/usr/SysUserSelectUpdtView.do'/>";
    document.listForm.submit();
      
}
function fnAddUserView() {
    document.listForm.action = "<c:url value='/mng/usr/SysUserInsertView.do'/>";
    document.listForm.submit();
}
function fnLinkPage(pageNo){
    document.listForm.pageIndex.value = pageNo;
    document.listForm.action = "<c:url value='/mng/usr/SysUserManage.do'/>";
    document.listForm.submit();
}
function fnSearch(){
                ...
                <main>
                    <div class="container-fluid px-4">
                                ...
                                <div class="condition">
                                    ...
                                    <a href="<c:url value='/mng/usr/SysUserInsertView.do'/>" class="item btn btn_blue_46 w_100" onclick="fnAddUserView(); return false;"><spring:message code="button.create" /></a><!-- 등록 -->
                                </div>
                                <!--// 검색조건 -->
