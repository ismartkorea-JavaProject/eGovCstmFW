...
public class CmmLoginServiceImpl extends EgovAbstractServiceImpl implements
        CmmLoginService {
	...
	public LoginVO actionLogin(LoginVO vo) throws Exception {
    	...
    	LoginVO loginVO = cmmloginDAO.actionLogin(vo);
	...
	public LoginVO searchId(LoginVO vo) throws Exception {
    	...
    	LoginVO loginVO = cmmloginDAO.searchId(vo);
	...
	public boolean searchPassword(LoginVO vo) throws Exception {
    	...
    	LoginVO loginVO = cmmloginDAO.searchPassword(vo);
    	...
    	cmmloginDAO.updatePassword(pwVO);
