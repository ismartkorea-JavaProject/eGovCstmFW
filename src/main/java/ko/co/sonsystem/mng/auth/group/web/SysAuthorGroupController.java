...
public class SysAuthorGroupController {
	 ...
	 * @exception Exception
	 */
    @RequestMapping("/mng/auth/grp/SysAuthorGroupListView.do")
    public String selectAuthorGroupListView() throws Exception {

        return "/mng/auth/SysAuthorGroupManage";
    }    
	 ...
	 * @exception Exception
	 */
    @RequestMapping(value="/mng/auth/grp/SysAuthorGroupList.do")
	 ...
	 * @exception Exception
	 */
	@RequestMapping(value="/mng/auth/grp/SysAuthorGroupInsert.do")
	public String insertAuthorGroup(@RequestParam("userIds") String userIds,
		...
		return "forward:/mng/auth/grp/SysAuthorGroupList.do";
	}
	 ...
	 * @exception Exception
	 */ 
	@RequestMapping(value="/mng/auth/grp/SysAuthorGroupDelete.do")
