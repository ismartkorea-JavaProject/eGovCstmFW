...
public class SysAuthorRoleManageDAO extends EgovAbstractMapper {
	...
	public AuthorRoleManageVO selectAuthorRole(AuthorRoleManageVO authorRoleManageVO) throws Exception {
		return (AuthorRoleManageVO) selectOne("system.auth.authorRoleManageDAO.selectAuthorRole", authorRoleManageVO);
	}
	...
	public List<AuthorRoleManageVO> selectAuthorRoleList(AuthorRoleManageVO authorRoleManageVO) throws Exception {
		return (List<AuthorRoleManageVO>) list("system.auth.authorRoleManageDAO.selectAuthorRoleList", authorRoleManageVO);
	}
	...
	public void insertAuthorRole(AuthorRoleManage authorRoleManage) throws Exception {
		insert("system.auth.authorRoleManageDAO.insertAuthorRole", authorRoleManage);
	}
	...
	public void updateAuthorRole(AuthorRoleManage authorRoleManage) throws Exception {
		update("system.auth.authorRoleManageDAO.updateAuthorRole", authorRoleManage);
	}
	...
	public void deleteAuthorRole(AuthorRoleManage authorRoleManage) throws Exception {
		delete("system.auth.authorRoleManageDAO.deleteAuthorRole", authorRoleManage);
	}
	...
	public int selectAuthorRoleListTotCnt(AuthorRoleManageVO authorRoleManageVO) throws Exception {
		return (Integer)selectOne("system.auth.authorRoleManageDAO.selectAuthorRoleListTotCnt", authorRoleManageVO);
	}
