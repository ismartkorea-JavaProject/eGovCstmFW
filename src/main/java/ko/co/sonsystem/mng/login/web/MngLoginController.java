...
//		}
	 ...
	 * @exception Exception
	 */
	@RequestMapping(value = "/mng/login/actionLogin.do")
	public String actionLogin(@ModelAttribute("loginVO") LoginVO loginVO, HttpServletResponse response, HttpServletRequest request, ModelMap model) throws Exception {
		...
		log.debug("\n >>> resultVO.getId() : " + resultVO.getId() + " <<<");
		log.debug(">>> resultVO.getPassword() : " + resultVO.getPassword() + " <<< \n");
		...
		if (resultVO != null && resultVO.getId() != null && !resultVO.getId().equals("") && loginPolicyYn) {
			...
			return "forward:/mng/main/sysMainView.do"; // 성공 시 페이지.. (redirect 불가)
	...
	public String actionSecurityLogin(@ModelAttribute("loginVO") LoginVO loginVO, HttpServletResponse response, HttpServletRequest request, ModelMap model) throws Exception {
		...
		// 접속IP
		String userIp = EgovClntInfo.getClntIP(request);
		log.debug("\n### actionSecurityLogin::userIp : " + userIp + " ###\n");		
	 ...
	 * @exception Exception
	 */
	@RequestMapping(value = "/mng/login/actionMain.do")
	public String actionMain(HttpServletResponse response, HttpServletRequest request, ModelMap model) throws Exception {
		...
		// 2. 메인 페이지 이동
		return "forward:/mng/main/sysMainView.do";
	}
