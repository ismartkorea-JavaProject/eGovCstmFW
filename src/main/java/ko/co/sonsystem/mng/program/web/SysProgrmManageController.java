...
public class SysProgrmManageController {
	 ...
	 * @exception Exception
	 */
	@RequestMapping(value = "/mng/prm/SysProgramListDetailSelect.do")
	public String selectProgrm(@RequestParam("tmp_progrmNm") String tmp_progrmNm, @ModelAttribute("searchVO") ComDefaultVO searchVO, ModelMap model) throws Exception {
		...
		return "mng/prm/SysProgramListDetailSelectUpdt";
	}
	 ...
	 * @exception Exception
	 */
	@RequestMapping(value = "/mng/prm/SysProgramListManageSelect.do")
	public String selectProgrmList(@ModelAttribute("searchVO") ComDefaultVO searchVO, ModelMap model) throws Exception {
		...
		return "mng/prm/SysProgramListManage";
	 ...
	 * @exception Exception
	 */
	@RequestMapping("/mng/prm/SysProgrmManageListDelete.do")
	public String deleteProgrmManageList(@RequestParam("checkedProgrmFileNmForDel") String checkedProgrmFileNmForDel,
		...
		if (delProgrmFileNm == null || (delProgrmFileNm.length == 0)) {
			...
			sLocationUrl = "forward:/mng/prm/SysProgramListManageSelect.do";
		} else {
	 ...
	 * @exception Exception
	 */
	@RequestMapping(value = "/mng/prm/SysProgramListRegist.do")
	public String insertProgrmList(@RequestParam Map<String, Object> commandMap, @ModelAttribute("progrmManageVO") ProgrmManageVO progrmManageVO, BindingResult bindingResult,
		...
		if (sCmd.equals("insert")) {
			...
			if (bindingResult.hasErrors()) {
				sLocationUrl = "mng/prm/SysProgramListRegist";
				return sLocationUrl;
			}
	 ...
	 */
	/*프로그램목록수정*/
	@RequestMapping(value = "/mng/prm/SysProgramListDetailSelectUpdt.do")
	public String updateProgrmList(@ModelAttribute("progrmManageVO") ProgrmManageVO progrmManageVO, BindingResult bindingResult, ModelMap model) throws Exception {
		...
		beanValidator.validate(progrmManageVO, bindingResult);
		if (bindingResult.hasErrors()) {
			sLocationUrl = "forward:/mng/prm/SysProgramListDetailSelect.do";
			return sLocationUrl;
		}
		if (progrmManageVO.getProgrmDc() == null || progrmManageVO.getProgrmDc().equals("")) {
			progrmManageVO.setProgrmDc(" ");
	 ...
	 * @exception Exception
	 */
	@RequestMapping(value = "/mng/prm/SysProgramListManageDelete.do")
	 ...
	 * @exception Exception
	 */
	@RequestMapping(value = "/mng/prm/SysProgramChangeRequstSelect.do")
	public String selectProgrmChangeRequstList(@ModelAttribute("searchVO") ComDefaultVO searchVO, ModelMap model) throws Exception {
		...
		return "mng/prm/SysProgramChangeRequst";
	}
	 ...
	 * @exception Exception
	 */
	@RequestMapping(value = "/mng/prm/SysProgramChangRequstDetailSelect.do")
	public String selectProgrmChangeRequst(@ModelAttribute("progrmManageDtlVO") ProgrmManageDtlVO progrmManageDtlVO, ModelMap model) throws Exception {
		...
		return "mng/prm/SysProgramChangRequstDetailSelectUpdt";
	}
	 ...
	 */
	/*프로그램변경요청등록*/
	@RequestMapping(value = "/mng/prm/SysProgramChangRequstStre.do")
	public String insertProgrmChangeRequst(@RequestParam Map<String, Object> commandMap, @ModelAttribute("progrmManageDtlVO") ProgrmManageDtlVO progrmManageDtlVO,
		...
		if (sCmd.equals("insert")) {
			...
			resultMsg = egovMessageSource.getMessage("success.common.insert");
			sLocationUrl = "forward:/mng/prm/SysProgramChangeRequstSelect.do";
		} else {
			/* MAX요청번호 조회 */
			...
			sLocationUrl = "mng/prm/SysProgramChangRequstStre";
		}
		model.addAttribute("resultMsg", resultMsg);
		return sLocationUrl;
	}
	 ...
	 * @exception Exception
	 */
	@RequestMapping(value = "/mng/prm/SysProgramChangRequstDetailSelectUpdt.do")
	public String updateProgrmChangeRequst(@ModelAttribute("progrmManageDtlVO") ProgrmManageDtlVO progrmManageDtlVO, BindingResult bindingResult, ModelMap model) throws Exception {
		...
		beanValidator.validate(progrmManageDtlVO, bindingResult);
		if (bindingResult.hasErrors()) {
			sLocationUrl = "forward:/mng/prm/SysProgramChangRequstDetailSelect.do";
			return sLocationUrl;
		}
	 ...
	 * @exception Exception
	 */
	@RequestMapping(value = "/mng/prm/SysProgramChangRequstDelete.do")
	 ...
	 * @exception Exception
	 */
	@RequestMapping(value = "/mng/prm/SysProgramChangeRequstProcessListSelect.do")
	public String selectProgrmChangeRequstProcessList(@ModelAttribute("searchVO") ComDefaultVO searchVO, ModelMap model) throws Exception {
		...
		return "mng/prm/SysProgramChangeRequstProcess";
	}
	 ...
	 * @exception Exception
	 */
	@RequestMapping(value = "/mng/prm/SysProgramChangRequstProcessDetailSelect.do")
	public String selectProgrmChangRequstProcess(@ModelAttribute("progrmManageDtlVO") ProgrmManageDtlVO progrmManageDtlVO, ModelMap model) throws Exception {
		...
		model.addAttribute("progrmManageDtlVO", resultVO);
		return "mng/prm/SysProgramChangRequstProcessDetailSelectUpdt";
	}
	 ...
	 * @exception Exception
	 */
	@RequestMapping(value = "/mng/prm/SysProgramChangRequstProcessDetailSelectUpdt.do")
	public String updateProgrmChangRequstProcess(@ModelAttribute("progrmManageDtlVO") ProgrmManageDtlVO progrmManageDtlVO, BindingResult bindingResult, ModelMap model)
		...
		beanValidator.validate(progrmManageDtlVO, bindingResult);
		if (bindingResult.hasErrors()) {
			sLocationUrl = "forward:/mng/prm/SysProgramChangRequstProcessDetailSelect.do";
			return sLocationUrl;
		}
		...
		if (progrmManageDtlVO.getOpetrId().equals(user.getId())) {
			...
			sLocationUrl = "forward:/mng/prm/SysProgramChangeRequstProcessListSelect.do";
		} else {
	 ...
	 */
	/*프로그램변경요청처리 삭제*/
	@RequestMapping(value = "/mng/prm/SysProgramChangRequstProcessDelete.do")
	public String deleteProgrmChangRequstProcess(@ModelAttribute("progrmManageDtlVO") ProgrmManageDtlVO progrmManageDtlVO, ModelMap model) throws Exception {
		...
		return "forward:/mng/prm/SysProgramChangeRequstProcessListSelect.do";
	}
	 ...
	 * @exception Exception
	 */
	@RequestMapping(value = "/mng/prm/SysProgramChgHstListSelect.do")
	public String selectProgrmChgHstList(@ModelAttribute("searchVO") ComDefaultVO searchVO, ModelMap model) throws Exception {
		...
		return "mng/prm/SysProgramChgHst";
	}
	 ...
	 * @exception Exception
	 */
	@RequestMapping(value = "/mng/prm/SysProgramChgHstListDetailSelect.do")
	public String selectProgramChgHstListDetail(@ModelAttribute("progrmManageDtlVO") ProgrmManageDtlVO progrmManageDtlVO, ModelMap model) throws Exception {
		...
		return "mng/prm/SysProgramChgHstDetail";
	}
	 ...
	 * @exception Exception
	 */
	@RequestMapping(value = "/mng/prm/SysProgramListSearch.do")
	public String selectProgrmListSearch(@ModelAttribute("searchVO") ComDefaultVO searchVO, ModelMap model) throws Exception {
		...
		return "mng/prm/SysFileNmSearch";
