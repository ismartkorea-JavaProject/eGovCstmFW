...
public class SysLoginPolicyController {
	 ...
	 */
	@RequestMapping("/mng/policy/selectLoginPolicyListView.do")
	public String selectLoginPolicyListView() throws Exception {
		return "/mng/policy/SysLoginPolicyList";
	}
	 ...
	 * @return String - 리턴 Url
	 */
	@RequestMapping("/mng/policy/selectLoginPolicyList.do")
	 ...
	 * @return String - 리턴 Url
	 */
	@RequestMapping("/mng/policy/getLoginPolicy.do")
	public String selectLoginPolicy(@RequestParam("emplyrId") String emplyrId, @ModelAttribute("loginPolicyVO") LoginPolicyVO loginPolicyVO, ModelMap model) throws Exception {
		...
		if (vo.getRegYn().equals("N"))
			return "/mng/policy/SysLoginPolicyRegist";
		else
			return "/mng/policy/SysLoginPolicyUpdt";
	}
	 ...
	 * @return String - 리턴 Url
	 */
	@RequestMapping("/mng/policy/addLoginPolicyView.do")
	 ...
	 * @return String - 리턴 Url
	 */
	@RequestMapping("/mng/policy/addLoginPolicy.do")
	public String insertLoginPolicy(@ModelAttribute("loginPolicy") LoginPolicy loginPolicy, BindingResult bindingResult, ModelMap model) throws Exception {
		...
		if (bindingResult.hasErrors()) {
			...
			return "forward:/mng/policy/getLoginPolicy.do";
		}
	}
	 ...
	 * @return String - 리턴 Url
	 */
	@RequestMapping("/mng/policy/updtLoginPolicy.do")
	public String updateLoginPolicy(@ModelAttribute("loginPolicy") LoginPolicy loginPolicy, BindingResult bindingResult, ModelMap model) throws Exception {
		...
		if (bindingResult.hasErrors()) {
			...
			return "forward:/mng/policy/selectLoginPolicyList.do";
		}
	}
	 ...
	 * @return String - 리턴 Url
	 */
	@RequestMapping("/mng/policy/removeLoginPolicy.do")
