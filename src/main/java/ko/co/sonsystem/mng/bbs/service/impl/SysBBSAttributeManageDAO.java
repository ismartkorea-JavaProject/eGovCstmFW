...
public class SysBBSAttributeManageDAO extends EgovAbstractMapper {
	...
	update("system.bbs.BBSAttributeManageDAO.deleteBBSMasterInf", boardMaster);
    }
	...
	return insert("system.bbs.BBSAttributeManageDAO.insertBBSMasterInf", boardMaster);
    }
	...
	return (BoardMasterVO)selectOne("system.bbs.BBSAttributeManageDAO.selectBBSMasterInf", vo);
    }
	...
	return (List<BoardMasterVO>) list("system.bbs.BBSAttributeManageDAO.selectBBSMasterInfs", vo);
    }
	...
	return (Integer)selectOne("system.bbs.BBSAttributeManageDAO.selectBBSMasterInfsCnt", vo);
    }
	...
	update("system.bbs.BBSAttributeManageDAO.updateBBSMasterInf", boardMaster);
    }
	...
	return (List<BoardMasterVO>) list("system.bbs.BBSAttributeManageDAO.selectAllBBSMaster", vo);
    }
	...
	return (List<BoardMasterVO>) list("system.bbs.BBSAttributeManageDAO.selectBdMstrListByTrget", vo);
    }
	...
	return (Integer)selectOne("system.bbs.BBSAttributeManageDAO.selectBdMstrListCntByTrget", vo);
    }
	...
	return (List<BoardMasterVO>) list("system.bbs.BBSAttributeManageDAO.selectAllBdMstrByTrget", vo);
    }
	...
	return (List<BoardMasterVO>) list("system.bbs.BBSAttributeManageDAO.selectNotUsedBdMstrList", vo);
    }
	...
	return (Integer)selectOne("system.bbs.BBSAttributeManageDAO.selectNotUsedBdMstrListCnt", vo);
    }
}
