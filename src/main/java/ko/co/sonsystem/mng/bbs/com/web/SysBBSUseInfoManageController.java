...
public class SysBBSUseInfoManageController {
	 ...
	 * @throws Exception
	 */
	@RequestMapping("/mng/bbs/com/deleteBBSUseInf.do")
	public String deleteBBSUseInf(@ModelAttribute("searchVO") BoardUseInfVO bdUseVO, @ModelAttribute("bdUseInf") BoardUseInf bdUseInf, SessionStatus status, ModelMap model)
		...
		return "forward:/mng/bbs/com/selectBBSUseInfs.do";
	}
	 ...
	 * @throws Exception
	 */
	@RequestMapping("/mng/bbs/com/insertBBSUseInf.do")
	 ...
	 * @throws Exception
	 */
	@RequestMapping("/mng/bbs/com/selectBBSUseInfs.do")
	public String selectBBSUseInfs(@ModelAttribute("searchVO") BoardUseInfVO bdUseVO, ModelMap model) throws Exception {
		...
		bdUseVO.setPageUnit(10);
		bdUseVO.setPageSize(10);		
		...
		return "mng/bbs/com/SysBoardUseInfList";
	}
	 ...
	 * @throws Exception
	 */
	@RequestMapping("/mng/bbs/com/updateBBSUseInf.do")
	 ...
	 * @throws Exception
	 */
	@RequestMapping("/mng/bbs/com/selectBBSUseInf.do")
	public String selectBBSUseInf(@ModelAttribute("searchVO") BoardUseInfVO bdUseVO, ModelMap model) throws Exception {
		...
		if ("SYSTEM_DEFAULT_BOARD".equals(vo.getTrgetId())) {
			if (vo.getBbsTyCode().equals("BBST02")) { // 익명게시판
				vo.setProvdUrl("/mng/bbs/anonymous/selectBoardList.do?bbsId=" + vo.getBbsId());
			} else {
				vo.setProvdUrl("/mng/bbs/selectBoardList.do?bbsId=" + vo.getBbsId());
			}
		}

		model.addAttribute("bdUseVO", vo);
		return "mng/bbs/com/SysBoardUseInfInqire";
	}
	 ...
	 * @throws Exception
	 */
	@RequestMapping("/mng/bbs/com/selectBBSUseInfsByTrget.do")
	public String selectBBSUseInfsByTrget(@ModelAttribute("searchVO") BoardUseInfVO bdUseVO, ModelMap model) throws Exception {
		...
		return "mng/bbs/com/SysBdUseInfListByTrget";
	}
	 ...
	 * @throws Exception
	 */
	@RequestMapping("/mng/bbs/com/updateBBSUseInfByTrget.do")
	public String updateBBSUseInfByTrget(@ModelAttribute("searchVO") BoardUseInfVO bdUseVO, @ModelAttribute("boardUseInf") BoardUseInf boardUseInf,
		...
		return "forward:/mng/bbs/com/selectBBSUseInfsByTrget.do";
	}
	 ...
	 * @throws Exception
	 */
	@RequestMapping("/mng/bbs/com/insertBBSUseInfByTrget.do")
