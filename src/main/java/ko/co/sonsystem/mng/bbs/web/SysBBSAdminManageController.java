...
public class SysBBSAdminManageController {
	 ...
	 * @throws Exception
	 */
	@RequestMapping("/mng/bbs/noti/selectBoardList.do")
	public String selectBoardArticles(@ModelAttribute("searchVO") BoardVO boardVO, ModelMap model, HttpServletRequest request) throws Exception {
		...
		//-------------------------------
		if (master != null && master.getBbsTyCode().equals("BBST04")) {
		...
		// 기본 BBS template 지정
		//-------------------------------
		if (master !=null && master.getTmplatCours() == null || master !=null && master.getTmplatCours().equals("")) {
		...
		return "mng/bbs/noti/SysNoticeList";
	}
	 ...
	 * @throws Exception
	 */
	@RequestMapping("/mng/bbs/noti/selectBoardArticle.do")
	public String selectBoardArticle(@ModelAttribute("searchVO") BoardVO boardVO, ModelMap model) throws Exception {
		...
		return "mng/bbs/noti/SysNoticeInqire";
	}
	 ...
	 * @throws Exception
	 */
	@RequestMapping("/mng/bbs/noti/addBoardArticle.do")
	public String addBoardArticle(@ModelAttribute("searchVO") BoardVO boardVO, ModelMap model) throws Exception {
		...
		return "mng/bbs/noti/SysNoticeRegist";
	}
	 ...
	 * @throws Exception
	 */
	@RequestMapping("/mng/bbs/noti/insertBoardArticle.do")
	public String insertBoardArticle(final MultipartHttpServletRequest multiRequest, @ModelAttribute("searchVO") BoardVO boardVO, @ModelAttribute("bdMstr") BoardMaster bdMstr,
		...
		//status.setComplete();
		return "forward:/mng/bbs/noti/selectBoardList.do";
	}
	 ...
	 * @throws Exception
	 */
	@RequestMapping("/mng/bbs/noti/addReplyBoardArticle.do")
	public String addReplyBoardArticle(@ModelAttribute("searchVO") BoardVO boardVO, ModelMap model) throws Exception {
		...
		return "mng/bbs/noti/SysNoticeReply";
	}
	 ...
	 * @throws Exception
	 */
	@RequestMapping("/mng/bbs/noti/replyBoardArticle.do")
	 ...
	 * @throws Exception
	 */
	@RequestMapping("/mng/bbs/noti/forUpdateBoardArticle.do")
	public String selectBoardArticleForUpdt(@ModelAttribute("searchVO") BoardVO boardVO, @ModelAttribute("board") BoardVO vo, ModelMap model) throws Exception {
		...
		return "mng/bbs/noti/SysNoticeUpdt";
	}
	 ...
	 * @throws Exception
	 */
	@RequestMapping("/mng/bbs/noti/updateBoardArticle.do")
	 ...
	 * @throws Exception
	 */
	@RequestMapping("/mng/bbs/noti/deleteBoardArticle.do")
