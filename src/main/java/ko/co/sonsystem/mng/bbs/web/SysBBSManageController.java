...
public class SysBBSManageController {
	 ...
	 * @throws Exception
	 */
	@RequestMapping("/mng/bbs/selectBoardList.do")
	public String selectBoardArticles(@ModelAttribute("searchVO") BoardVO boardVO, ModelMap model, HttpServletRequest request) throws Exception {
		...
		if (master.getBbsTyCode().equals("BBST04")) {
			return "forward:/mng/bbs/selectGuestList.do";
		}
		////-----------------------------
		...
		if (master.getTmplatCours() == null || master.getTmplatCours().equals("")) {
			master.setTmplatCours("/css/egovframework/mng/bbs/egovBaseTemplate.css");
		}
		////-----------------------------
	 ...
	 * @throws Exception
	 */
	@RequestMapping("/mng/bbs/selectBoardArticle.do")
	public String selectBoardArticle(@ModelAttribute("searchVO") BoardVO boardVO, ModelMap model) throws Exception {
		...
		if (masterVo.getTmplatCours() == null || masterVo.getTmplatCours().equals("")) {
			masterVo.setTmplatCours("/css/egovframework/mng/bbs/egovBaseTemplate.css");
		}

		model.addAttribute("brdMstrVO", masterVo);

		return "mng/bbs/SysNoticeInqire";
	}
	 ...
	 * @throws Exception
	 */
	@RequestMapping("/mng/bbs/addBoardArticle.do")
	public String addBoardArticle(@ModelAttribute("searchVO") BoardVO boardVO, ModelMap model) throws Exception {
		...
		if (bdMstr.getTmplatCours() == null || bdMstr.getTmplatCours().equals("")) {
			bdMstr.setTmplatCours("/css/egovframework/mng/bbs/egovBaseTemplate.css");
		}

		model.addAttribute("brdMstrVO", bdMstr);
		////-----------------------------

		return "mng/bbs/SysNoticeRegist";
	}
	 ...
	 * @throws Exception
	 */
	@RequestMapping("/mng/bbs/insertBoardArticle.do")
	public String insertBoardArticle(final MultipartHttpServletRequest multiRequest, @ModelAttribute("searchVO") BoardVO boardVO, @ModelAttribute("bdMstr") BoardMaster bdMstr,
		...
		//status.setComplete();
		return "forward:/mng/bbs/selectBoardList.do";
	}
	 ...
	 * @throws Exception
	 */
	@RequestMapping("/mng/bbs/addReplyBoardArticle.do")
	 ...
	 * @throws Exception
	 */
	@RequestMapping("/mng/bbs/replyBoardArticle.do")
	 ...
	 * @throws Exception
	 */
	@RequestMapping("/mng/bbs/forUpdateBoardArticle.do")
	public String selectBoardArticleForUpdt(@ModelAttribute("searchVO") BoardVO boardVO, @ModelAttribute("board") BoardVO vo, ModelMap model) throws Exception {
		...
		if (bmvo.getTmplatCours() == null || bmvo.getTmplatCours().equals("")) {
			bmvo.setTmplatCours("/css/egovframework/mng/bbs/egovBaseTemplate.css");
		}

		model.addAttribute("brdMstrVO", bmvo);
		////-----------------------------

		return "mng/bbs/SysNoticeUpdt";
	}
	 ...
	 * @throws Exception
	 */
	@RequestMapping("/mng/bbs/updateBoardArticle.do")
	 ...
	 * @throws Exception
	 */
	@RequestMapping("/mng/bbs/deleteBoardArticle.do")
	 ...
	 * @throws Exception
	 */
	@RequestMapping("/mng/bbs/previewBoardList.do")
