...
public class SysTemplateManageController {
	 ...
	 * @throws Exception
	 */
	@RequestMapping("/mng/bbs/com/selectTemplateInfs.do")
	public String selectTemplateInfs(HttpServletRequest request, @ModelAttribute("searchVO") TemplateInfVO tmplatInfVO, ModelMap model) throws Exception {
		...
		return "mng/bbs/com/SysTemplateList";
	}
	 ...
	 * @throws Exception
	 */
	@RequestMapping("/mng/bbs/com/selectTemplateInf.do")
	public String selectTemplateInf(@ModelAttribute("searchVO") TemplateInfVO tmplatInfVO, ModelMap model) throws Exception {
		...
		return "mng/bbs/com/SysTemplateUpdt";
	}
	 ...
	 * @throws Exception
	 */
	@RequestMapping("/mng/bbs/com/insertTemplateInf.do")
	public String insertTemplateInf(@ModelAttribute("searchVO") TemplateInfVO searchVO, @ModelAttribute("templateInf") TemplateInf templateInf, BindingResult bindingResult,
		...
		if (bindingResult.hasErrors()) {
			...
			return "mng/bbs/com/SysTemplateRegist";
		}
		...
		return "forward:/mng/bbs/com/selectTemplateInfs.do";
	}
	 ...
	 * @throws Exception
	 */
	@RequestMapping("/mng/bbs/com/addTemplateInf.do")
	 ...
	 * @throws Exception
	 */
	@RequestMapping("/mng/bbs/com/updateTemplateInf.do")
	 ...
	 * @throws Exception
	 */
	@RequestMapping("/mng/bbs/com/deleteTemplateInf.do")
	 ...
	 * @throws Exception
	 */
	@RequestMapping("/mng/bbs/com/selectTemplateInfsPop.do")
	public String selectTemplateInfsPop(@ModelAttribute("searchVO") TemplateInfVO tmplatInfVO, @RequestParam Map<String, Object> commandMap, ModelMap model) throws Exception {
		...
		return "mng/bbs/com/SysTemplateInqirePopup";
	}
	 ...
	 * @throws Exception
	 */
	@RequestMapping("/mng/bbs/com/openPopup.do")
	public String openPopupWindow(@RequestParam Map<String, Object> commandMap, ModelMap model) throws Exception {
		...
		return "/mng/bbs/com/SysModalPopupFrame";
	}
}
