...
//				"/cop/bbs/*Master*.do",
	...
	public void addViewControllers(ViewControllerRegistry registry) {
		registry.addViewController("/mng/cmmn/validator.do")
			.setViewName("cmm/validator");
		//registry.addViewController("/").setViewName("forward:/index.html");
		registry.addViewController("/mng/login/loginView.do").setViewName("mng/login/SysLogin");
	}
