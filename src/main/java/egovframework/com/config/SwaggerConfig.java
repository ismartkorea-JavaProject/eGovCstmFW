...
public class SwaggerConfig {
	...
	private static final String API_NAME = "CMS Project API";
	private static final String API_VERSION = "4.1.0";
	private static final String API_DESCRIPTION = "CMS(Contents Management System) 프로젝트 명세서";
	private static final String API_BASE_PACKAGE = "ko.co.sonsystem";
	...
	public ApiInfo apiInfo() {
		return new ApiInfoBuilder()
				...
				.contact(new Contact("eGovFrame", "http://www.s-onsystem.co.kr/", "support@s-onsystem.co.kr"))
				.build();
	}
